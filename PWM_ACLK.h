...
//Timer_A,TA0
    ...
    TA0CCR1 = 500; //  PWM   P1.2
    TA0CCTL2 = OUTMOD_7;//  P1.3ΪOUTMOD_7ģʽ
    TA0CCR2 =500;   //  PWM   P1.3
    TA0CCTL3 = OUTMOD_7;//  P1.3ΪOUTMOD_7ģʽ
    TA0CCR3 =500;   //  PWM   P1.4
    TA0CCTL4 = OUTMOD_7;//  P1.3ΪOUTMOD_7ģʽ
    TA0CCR4 =500;   //  PWM   P1.5
    TA0CTL = TASSEL_1 + MC_1 +TACLR;
//Timer_A,TA1
    P2DIR |= BIT0 + BIT1+BIT3+BIT4;  // P1.0,1,3,4
    P2SEL |= BIT0 + BIT1+BIT3+BIT4;  // P1.0,1,3,4
    TA1CCR0 = Cycle;    //  PWM
    TA1CCTL1 =OUTMOD_7;
    TA1CCR1 = 500; //  PWM   P2.0
    TA1CCTL2 = OUTMOD_7;//  P2.1ΪOUTMOD_7ģʽ
    TA1CCR2 =500;   //  PWM   P2.1
